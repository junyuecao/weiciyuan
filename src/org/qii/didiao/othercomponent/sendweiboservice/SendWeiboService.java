package org.qii.didiao.othercomponent.sendweiboservice;
...
import org.qii.didiao.dao.send.StatusNewMsgDao;
...
import org.qii.didiao.support.utils.NotificationUtility;
    ...
    private class WeiboSendTask extends MyAsyncTask<Void, Long, Void> {
        ...
        protected void onPreExecute() {
            ...
            if (Utility.isJB()) {
                ...
                IntentFilter intentFilter = new IntentFilter("org.qii.didiao.SendWeiboService.stop." + String.valueOf(notificationId));

                registerReceiver(receiver, intentFilter);

                Intent broadcastIntent = new Intent("org.qii.didiao.SendWeiboService.stop." + String.valueOf(notificationId));
