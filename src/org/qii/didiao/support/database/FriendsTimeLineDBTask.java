package org.qii.didiao.support.database;
...
import org.qii.didiao.support.database.table.HomeTable;
...
public class FriendsTimeLineDBTask {
     ...
     * didiao will save 1000 messages to database, but at the next time when
